...
def main():
    ...
    # Build LMDB datasets from directory and filter pattern (same as ensemble-data-inference-gh.py)
    ...
    # Define dataset construction parameters as in the GH script
    # Direction model expects 5 node features: exclude telescope angles from node features
    features = ['x_cam', 'y_cam', 't', 'tel_id', 'signal']
    pulsemaps = ['total']
