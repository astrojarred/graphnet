...
def main(
    ...
    wandb: bool = False,
    wandb_project: str = "gnn-classification-a",
    ...
    run_name = f"magic_baseline_classification_{config.target}"
...
if __name__ == "__main__":
    ...
    parser = ArgumentParser(
        description="""
            Train GNN classification model for MAGIC data.
            """
    )
